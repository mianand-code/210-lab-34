...
public:
    ...
    // - a minimum spanning tree is formed by creating a "tree" of all of the graph's edges that provide a connection to all of the graph's nodes, via the minimum total edge weight
    // ARGUMENTS: no arguments/parameters
    // RETURNS: nothing, void function
